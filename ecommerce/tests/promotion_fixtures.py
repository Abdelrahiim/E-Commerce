...
@pytest.fixture
def coupon(db):
    coupon = Coupon.objects.create(name="default", coupon_code="default")
    return coupon
...
def promotion_multi_variant(
    db, single_promotion_type, coupon, single_sub_product_with_media_and_attributes
):
    ...
    promotion.product_on_promotion.add(
        single_sub_product["inventory"], through_defaults={"promo_price": "100.00"}
    )
    return promotion
